                ...
                Forms\Components\Section::make('Available months')
                    ...
                    ->schema([
                        CheckboxList::make('term_groups.0.months')
                            ...
                            ->columnSpanFull(),
                        TextInput::make('rate_plan_a')
                            ->label('Plan A - financial charge rate')
                            ->numeric()
                            ->suffix('% per month')
                            ->default(2.5)
                            ->minValue(0)
                            ...
                            ->step(0.01)
                            ->required()
                            ->helperText('Financial charge = (price - advance) x rate x months. Used by the payment calculator.')
                            ->columnSpanFull(),
                        CheckboxList::make('term_groups.1.months')
                            ...
                            ->columnSpanFull(),
                        TextInput::make('rate_plan_b')
                            ->label('Plan B - financial charge rate')
                            ->numeric()
                            ->suffix('% per month')
                            ->default(2.5)
                            ->minValue(0)
                            ...
                            ->step(0.01)
                            ->required()
                            ->helperText('Financial charge = (price - advance) x rate x months. Used when Plan B is chosen.')
                            ->columnSpanFull(),

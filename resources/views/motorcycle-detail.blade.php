...
@php
    ...
    $heroStrip = [
        ['icon' => 'bike', 'title' => $engine ?: 'Electric', 'sub' => 'Engine capacity'],
        ['icon' => 'zap', 'title' => $keyTech, 'sub' => 'Key technology'],
        ['icon' => 'shield', 'title' => 'LITUS Warranty', 'sub' => 'Backed by our own network'],
        ['icon' => 'map-pin', 'title' => count($showrooms).' Showrooms', 'sub' => 'Ask us where stock is'],
    ];
...
<div class="font-sans"
    ...
    <section class="relative overflow-hidden bg-litus-ink text-white">
        <img src="{{ $heroBg }}"
             ...
             aria-hidden="true">
        <div class="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(5,11,24,0.96)_0%,rgba(5,11,24,0.88)_36%,rgba(5,11,24,0.55)_64%,rgba(5,11,24,0.4)_100%)] max-md:bg-[linear-gradient(180deg,rgba(5,11,24,0.55)_0%,rgba(5,11,24,0.82)_45%,rgba(5,11,24,0.96)_100%)]"></div>
    ...
    <section class="litus-sec" id="enquire">
        <div class="litus-container grid grid-cols-1 gap-12 min-[1000px]:grid-cols-[1.5fr_1fr] min-[1000px]:gap-12">
            <div>
                <span class="mb-3.5 block text-[11.5px] font-bold uppercase tracking-[0.19em] text-litus-primary">Technical Details</span>
                <h2 class="mb-[26px] font-display text-[clamp(26px,3.4vw,40px)] font-bold tracking-[-0.028em] text-litus-text">
                    {{ $motorcycle->name }} specifications
                </h2>

                <div class="overflow-x-auto">
                    <table class="w-full overflow-hidden rounded-[18px] border border-litus-line text-sm">
                        <thead>
                ...
                <div class="mt-[26px] rounded-r-[12px] border-l-4 border-litus-primary bg-[#EEF4FF] px-6 py-5">
                    <b class="mb-1.5 block text-[14.5px] text-litus-text">Specifications shown are indicative</b>
            ...
            <aside class="min-[1000px]:sticky min-[1000px]:top-[96px] min-[1000px]:self-start">
                <div class="rounded-[26px] border border-litus-line bg-white p-[clamp(26px,3vw,38px)] shadow-[0_1px_2px_rgba(9,17,32,.05),0_6px_16px_rgba(9,17,32,.05)]">
                    ...
                    <form action="{{ route('contact') }}" method="get" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="enquiry-showroom"
                                    name="showroom"
                                    class="w-full cursor-pointer rounded-[9px] border-[1.5px] border-litus-line-2 bg-white px-3.5 py-3 text-sm outline-none transition focus:border-litus-primary-light focus:shadow-[0_0_0_3px_rgba(46,116,238,0.14)]">
    ...
    <section class="litus-sec bg-litus-paper-2">
        <div class="litus-container">
            <div class="mx-auto mb-[clamp(34px,4vw,54px)] max-w-[660px] text-center">
                <span class="mb-3.5 block text-[11.5px] font-bold uppercase tracking-[0.19em] text-litus-primary">You May Also Like</span>
                <h2 class="font-display text-[clamp(26px,3.4vw,40px)] font-bold tracking-[-0.028em] text-litus-text">Other models worth comparing</h2>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                ...
                @empty
                    <div class="col-span-full rounded-[18px] border border-dashed border-litus-line-2 px-6 py-12 text-center text-litus-text-2">

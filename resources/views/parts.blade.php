    ...
    <section class="bg-litus-navy py-14">
        <div class="mx-auto flex max-w-5xl flex-col items-center gap-8 px-4 sm:px-6 lg:flex-row lg:gap-16">
            ...
            <div class="flex shrink-0 flex-col gap-3 sm:flex-row">
                ...
                <a href="#" class="rounded-full border border-white/30 px-8 py-3.5 text-sm font-bold text-white transition-all hover:border-white/60 hover:bg-white/5">Visit Service Center</a>
            </div>
        </div>
    </section>
